 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */fr(XI,ZI,"app");const eb={apiKey:"AIzaSyALY2Eu62yzZPuaySeDBI3ONz3DYCq2388",authDomain:"relay-hub.firebaseapp.com",projectId:"relay-hub",storageBucket:"relay-hub.appspot.com",messagingSenderId:"1088994606939",appId:"1:1088994606939:web:17dc0c1330726f959ca47e"},et=Vm(eb),tb=ft(et),nb=async()=>{const t=new kn;try{return(await oI(tb,t)).user}catch(e){throw console.error("Error during sign-in:",e),e}},rb=Ne({components:{ButtonDefault:Wn},emits:["onButtonClicked"],props:{},setup(){const t=Am(),e=re(!1);async function n(){e.value=!0;try{const r=await nb();t.setUser({uid:r.uid,displayName:r.displayName,email:r.email,photoURL:r.photoURL})}catch(r){t.setUser(null),console.error("Failed to sign in:",r)}}return{isLoading:e,onButtonClicked:n}}}),sb={class:"button-google"};function ib(t,e,n,r,s,i){const o=_e("ButtonDefault");return B(),Q("div",sb,[pe(o,{text:"Sign in with Google",isLoading:t.isLoading,onOnButtonClicked:t.onButtonClicked},{icon:Mn(()=>e[0]||(e[0]=[$("div",{class:"google-icon"},null,-1)])),_:1},8,["isLoading","onOnButtonClicked"])])}const ob=xe(rb,[["render",ib],["__scopeId","data-v-33e465cd"]]),ab=Ne({name:"sign-in",components:{ButtonGoogle:ob},setup(){return{}}}),lb={class:"sign-in"};function cb(t,e,n,r,s,i){const o=_e("button-google");return B(),Q("div",lb,[e[0]||(e[0]=$("div",{class:"relay-hub"},"RelayHub",-1)),pe(o)])}const ub=xe(ab,[["render",cb],["__scopeId","data-v-9540f920"]]),hb=Ne({name:"ToggleButton",props:{modelValue:{type:Boolean,required:!0},isBlocked:{type:Boolean,default:!1}},emits:["update:modelValue"],setup(t,{emit:e}){const n=re(t.modelValue),r=re(!1);return pn(()=>t.modelValue,i=>{n.value=i}),{isActive:n,toggleSwitch:()=>{t.isBlocked||r.value||(n.value=!n.value,r.value=!0,setTimeout(()=>r.value=!1,500),e("update:modelValue",n.value))}}}});function db(t,e,n,r,s,i){return B(),Q("div",{class:it(["toggle-switch",{active:t.isActive}]),onClick:e[0]||(e[0]=(...o)=>t.toggleSwitch&&t.toggleSwitch(...o))},e[1]||(e[1]=[$("div",{class:"switch"},null,-1)]),2)}const fb=xe(hb,[["render",db],["__scopeId","data-v-17dbdf4b"]]);var af=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
